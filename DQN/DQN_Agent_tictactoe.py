...
# Training loop
def train_dqn(env: TicTacToe, agent, num_episodes):
    ...
    for episode in range(num_episodes):
        ...
        while not done:
            ...
            next_state = next_state.view(-1)  # Shape becomes (9,)
    ...
    # save the agent
    torch.save(agent.q_network.state_dict(), 'qtic4k.pth')
...
train_dqn(env, agent, num_episodes=40000)